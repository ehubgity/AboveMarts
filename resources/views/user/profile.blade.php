...
<span class="btn btn-primary fileinput-button me-1">
        <input required type="file" name="file" accept="image/png, image/gif, image/jpeg">
</span>
<button type="submit" class="btn btn-lg btn-warning" >Update Profile Image</button>
</form>
...
<div class="table-responsive form-inline">
        ...
        <tbody>
        <form action="{{ route('profilesponsor') }}" method="post">
        @csrf
        <tr class="highlight">
        <td class="field">Sponsor</td>
        <td ><a href="javascript:;" class="text-decoration-none fw-bold"><input class="form-control" type="text" name ="sponsor" value="{{ auth()->user()->sponsor }}" placeholder="{{ auth()->user()->firstName }}" style="width:90%;"></a></td>
        </tr>
        ...
        <td class="field">&nbsp;</td>
        <td class="">
        <button type="submit" class="btn btn-primary w-150px">Update Sponsor</button>
        </td>
        </tr>
        </form>
        </tbody>
...
<td ><a href="javascript:;" class="text-decoration-none fw-bold"><input class="form-control" type="text" name ="currentpassword" placeholder="**********" style="width:90%;"></a></td>
</tr> --}}
<tr class="highlight">
