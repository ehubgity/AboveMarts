...
<small class="fs-12px text-gray-500-darker">Kindly enter a valid phone number.</small>
    ...
    <div id="promopayment"  style="display:none;">
        ...
        <label class="col-sm-6 col-form-label">Promo Amount($)</label>
            <div class="col-sm-6">
                <input type="number" name="promoamount" class="form-control" id="promoamount" placeholder="0" value="0" >
            </div>
        </div> 
    ...
    <div class="col-md-6">
    <input class="form-control" type="number" id="amountV" name ="amount" value="" placeholder="Enter Amount" required readonly />
    </div>
    </div>
    <div class="row mb-15px">
    <div class="col-md-2">
