        ...
        <div class="tab-content p-0">
            ...
            <div class="tab-pane fade show active" id="profile-about">
                ...
                <div class="row mt-4 mb-4">
                   ...
                   <form action="{{ route('getAccount') }}" method="POST">
                        @csrf
                        <div class="col-12 col-md-3 mb-2">
                            <button id="auto" type="submit" class="btn btn-danger w-200px">Get Account Number</button>
                        </div>
                    </form>
                    @endif
                    <div class="col-12 col-md-3 ">
                        <button id="auto" class="btn btn-primary w-200px">Instant Transfer</button>
                    </div>
                    <div class="col-12 col-md-3 mb-2">
                        <button id="manual" class="btn btn-success w-200px">Manual Deposit</button>
                    </div>
                     <div class="col-12 col-md-3 ">
                        <button id="card" class="btn btn-warning w-200px">Card Payment</button>
                    </div> 
                </div>

                <div class="row mb-15px" id="formAuto">
                    <div class="row">
                        <div class="col-12 mt-4 mb-4">
                            <h4>
                                You can fund your wallet by paying into the account number below and you will be
                                credited automatically.
                          
                            </h4>
                        </div>
                        <div class="col-12 mb-4">
                            <h6>Bank Name: VFD Microfinance </h6>
                            <h6>Account Number:</h6>
                            <div class='d-inline-flex'>
                            <!--<h6>Account Number: {{ auth()->user()->accountNumber }}</h6>-->
                            <input readonly class='' id="instantAccount" value='{{ auth()->user()->accountNumber }}'/>
                            <button id='referalButton' class='btn btn-secondary' onclick="copyInstantAccount()"><i class='fa fa-copy'></i></button>
                              </div>
                          ...
                          <h5>
                                Charges From 1% Only!
                                <!--or 1.5% where amount is above NGN3,500.-->
                            </h5>

                    </div>

                </div>
                <form action="{{ route('pay') }}" method="post" id="formCard" style="display: none;">
                      <div class="row mb-15px">
                        <div class="row">
                            <div class="col-12 mt-4 mb-4">
                                <h4>
                                    You can fund your wallet online via Card Payment or USSD Code. <a style='color:blue' href='https://paystack.com/pay/ebhops'>Click To Make Payment</a>
                                </h4>
                            </div>
                            <div class="col-12 mb-4">
                                Once you have made the payment, you will be redirected to Notify Admin via Whatsapp.<br>
                                You can also click the button below to Notify Admin via Whatsapp for approval.
                                <a style='color:blue' href='https://wa.link/8a27ka'>Click To Notify Admin</a>
                    ...
                    <div class="row mb-15px">
                        <div class="col-12 mt-4 mb-4">
                            <h5>
                                NOTE: Gateway Charge is 1% of the amount. However, amount above #2,450 attracts extra charges. Use the form below to calculate.
                    ...
                    <div class="row mb-15px">
                        ...
                        <div class="col-md-6">
                            <input class="form-control" type="number" oninput="myFunction()" id ="amountinitial"
                                name ="amountAuto" placeholder="Enter Amount" required />
                        </div>
                    </div>
                    <div class="row mb-15px">
                        <label class="form-label col-form-label col-md-2">Gateway Charge </label>
                        <div class="col-md-6">
                            <input class="form-control" type="number" name ="fee" id="fee" value=""
                                readonly required />
                        </div>
                    </div>
                    ...
                    <div class="row mb-15px">
                        ...
                        <div class="col-md-9">
                            <a href='https://paystack.com/pay/ebhops' type="submit" class="btn btn-primary w-150px">Fund Wallet</a>
                        </div>
                    </div>
                </form>
                ...
                <form action="{{ route('manualpay') }}" method="post" id="formManual" style="display: none;">
                    <div class="row mb-15px">
                        <div class="row">
                            <div class="col-12 mt-4 mb-4">
                                <h4>
                                    KINDLY NOTIFY ADMIN AFTER PAYMENT BY FILLING THE FORM BELOW.
                                </h4>
                            </div>
                            <div class="col-12 mb-4">
                                ...
                                <h6>Account Number: </h6>
                                 <div class='d-inline-flex'>
                            <!--<h6>Account Number: {{ auth()->user()->accountNumber }}</h6>-->
                            <input readonly class='' id="manualAccount" value='1228669880'/>
                            <a id='manualButton' class='btn btn-secondary' onclick="copyManualAccount()"><i class='fa fa-copy'></i></a>
                              </div>
                                <h6>Account Name: Above E-Business Hub</h6>
                            </div>
                    ...
                    <div class="row mb-15px">
                        ...
                        <div class="col-md-6">
                            <input class="form-control" type="text" value="none" name ="accountNumber"
                                hidden ="Enter Account Number" required />
                        </div>
                    </div>
                    <div class="row mb-15px">
                        ...
                        <div class="col-md-6">
                            <select name ="bankName" id="bankName" class="form-control" onchange="handleChange()">
                                ...
                                <option value="VPAY">VFD MFB</option>
                    ...
                    <div class="row mb-15px">
                        <label class="form-label col-form-label col-md-2">Amount</label>
                        <div class="col-md-6">
                            <input class="form-control" type="number" id ="amountinit" placeholder="Enter Amount"
                                oninput="myFunctionManual()" required />
                        </div>
                    </div>
                    ...
                    <div class="row mb-15px">
                        ...
                        <div class="col-md-6">
                            <input class="form-control" type="text" id="feeManual" value="50" readonly
                                name ="feeManual" required />
                        </div>
                    </div>
                    ...
                    <div class="row mb-15px">
                        <label class="form-label col-form-label col-md-2">Total Amount</label>
                        <div class="col-md-6">
                            <input class="form-control" type="number" id="amountManual" readonly
                                name ="amountManual" placeholder="Enter Amount" required />
                        </div>
                    </div>
...
<script>
    ...
    document.getElementById("auto").addEventListener("click", function() {
        ...
        var divThree = document.getElementById("formCard");
...
<script>
        function copyInstantAccount() {
            // Get the input field
            var referralCodeField = document.getElementById("instantAccount");
         ...
         function copyManualAccount() {
            // Get the input field
            var referralCodeField = document.getElementById("manualAccount");
            ...
            // Optionally, provide some visual feedback to the user (e.g., changing button text)
            // For simplicity, this example changes the button text briefly
            var copyButton = document.getElementById("manualButton");
            copyButton.textContent = "Copied!";
            setTimeout(function() {
                copyButton.textContent = "Copy";
            }, 1500);
