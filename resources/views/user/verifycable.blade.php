...
<h4> Cable TV Purchase</small></h4>
<form action="{{ route('tvsub') }}" id="my-form" method="post">
@csrf
    ...
    <div class="row mb-15px" id="amount">
        <label class="form-label col-form-label col-md-2">Smartcard Number</label>
        <div class="col-md-6">
        <input class="form-control" name="smartNumber" type="number" id="smartNumber" value ="{{ $data->smartNumber }}" readonly placeholder="Enter Smart Number" required />
        </div>
    </div>
    <div class="row mb-15px" id="amount">
        <label class="form-label col-form-label col-md-2">Name</label>
        <div class="col-md-6">
        <input class="form-control" type="text" name="cableName"  value ="{{ $data->cableName }}" readonly placeholder="Enter cable Name" required />
        </div>
    </div>
