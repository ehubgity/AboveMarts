...
<section style="margin-top:-5%;">
    <div class="container z-index-2 position-relative">
        <div class="section-heading mb-8 wow fadeIn" data-wow-delay="100ms">
            ...
            <h2 class="w-100">Recharge Card Printing Transaction<span class="font-weight-400"> Records</span></h2>
        </div>
</section>
...
<div class="alert alert-secondary alert-dismissible rounded-0 mb-0 fade show">
    ...
    @if ($dat->status == "CONFIRM")
    <form action="{{ route('cardprintinghistory') }}" method="post">
        <td>
            <a href="{{Route('cardprintinghistory', ['id' => $dat->transactionId])}}">
