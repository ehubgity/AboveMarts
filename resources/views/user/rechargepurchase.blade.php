...
<form action="{{ route('rechargepurchases') }}" id="my-form"  method="post">
@csrf
...
<div class="col-md-6">
<input class="form-control" type="number" name ="amount" placeholder="Enter Amount" required step="1" />
</div>
</div>
...
<div class="col-md-9">
<button type="submit"  id="submit-button"  class="btn btn-primary w-250px">Recharge Number</button>
</div>
</div>
</form>
</div>
