        ...
        <div class="breadcrumb-header justify-content-between">
            <div class="left-content">
                <div class="d-flex">
                    ...
                    <p class="text-muted mb-0 hover-cursor">&nbsp;/&nbsp;Edit Manager &nbsp;</p>
                    ...
                    <div class="row">
                        <div class="col-md-12 col-lg-12 col-xl-12 mx-auto d-block">
                            <div class="card card-body pd-10 pd-md-20 border shadow-none">
                                <h5 class="card-title mg-b-20">Edit Manager</h5>
                                <form action="{{ route('updateaccountmanagers') }}" method="post">
                                    @csrf
                                    <div class="form-group">
                                        <label class="main-content-label tx-11 tx-medium tx-gray-600">Name</label>
                                        <input class="form-control" value="{{ $manager->name }}" name="name" type="text" id="username">
                                    </div>
                                    <input class="form-control" name="id" type="text" id="username" value="{{ $manager->accountManagerId }}" hidden>
                                    <div class="form-group">
                                    ...
                                    <button class="btn btn-main-primary btn-block" name="sub" type="submit">Edit Manager</button>
                                </form>
                            </div>
                        </div>
                    </div>
