        ...
        <div class="breadcrumb-header justify-content-between">
            <div class="left-content">
                <div class="d-flex">
                    ...
                    <p class="text-muted mb-0 hover-cursor">&nbsp;/&nbsp;Create Manager &nbsp;</p>
                    ...
                    <div class="row">
                        <div class="col-md-12 col-lg-12 col-xl-12 mx-auto d-block">
                            <div class="card card-body pd-10 pd-md-20 border shadow-none">
                                <h5 class="card-title mg-b-20">New Account Manager</h5>
                                <form action="{{ route('storeaccountmanagers') }}" method="post">
                                    @csrf
                                    <div class="form-group">
                                        <label class="main-content-label tx-11 tx-medium tx-gray-600">Name</label> <input class="form-control" name="name" type="text" id="username">
                                    </div>
                                    <div class="form-group">
                                        <label class="main-content-label tx-11 tx-medium tx-gray-600">Email</label> <input class="form-control" name="email" type="text" id="email">
                                    </div>
                                    <div class="form-group">
                                    </div>
                                    <div class="form-group">
                                        <label class="main-content-label tx-11 tx-medium tx-gray-600">Password</label> <input class="form-control" name="password" type="text" id="password">
                                    </div>

                                    <button class="btn btn-main-primary btn-block" name="sub" type="submit">Add Manager</button>
                                </form>
                            </div>
                        </div>
                    </div>
