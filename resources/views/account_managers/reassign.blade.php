        ...
        <div class="breadcrumb-header justify-content-between">
            <div class="left-content">
                <div class="d-flex">
                    ...
                    <p class="text-muted mb-0 hover-cursor">&nbsp;/&nbsp;Reassign Manager &nbsp;</p>
                            ...
                            <div class="card card-body pd-10 pd-md-20 border shadow-none">
                                ...
                                <form action="{{ route('reassign') }}" method="post">
                                    ...
                                    <div class="form-group">
                                        <label class="main-content-label tx-11 tx-medium tx-gray-600">Username of the User</label> <input class="form-control" name="username" type="text" id="username">
                                    </div>
                                    <div class="form-group">
                                        <label class="main-content-label tx-11 tx-medium tx-gray-600">Email of the new Manager</label> <input class="form-control" name="manager_email" type="text" id="email">
                                    </div>
                                    <div class="form-group">
                                    </div>
