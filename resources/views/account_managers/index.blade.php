            ...
            <div class="card-body">
                ...
                <div class="table-responsive market-values">
                    <table class="table table-bordered table-hover table-striped text-nowrap mb-0 tx-13">
                        ...
                        @foreach ($managers as $datauser)

                        <tbody>
                            <tr class="border-bottom">
                                <td>{{ $datauser->name}}</td>
                                <td>{{ $datauser->email }}</td>
                                <td>{{ $datauser->noOfUsers }}</td>
                                <td>{{ $datauser->monthlyDeposit }}</td>
                                <td>{{ $datauser->monthlySpent }}</td>
                                <td>{{ $datauser->monthlyWithdraw }}</td>
                                <td>{{ $datauser->monthlyPackage }}</td>
                                <td>{{ $datauser->totalUsers }}</td>
                                <td>{{ $datauser->totalDeposit }}</td>
                                <td>{{ $datauser->totalSpent }}</td>
                                <td>{{ $datauser->totalWithdraw }}</td>
                                <td>{{ $datauser->totalPackage }}</td>
                                ...
                                <td>
                                    <div class="btn-group">
                                        ...
                                        @endif -->
                                        <a class="btn btn-success" title="View Users" href="{{ route('managers.users', ['id' => $datauser->accountManagerId]) }}">
                                            <i class="fa fa-user"></i>
                                        </a> <a class="btn btn-info" data-toggle="" title="Edit Manager" href="{{ route("editaccountmanagers", ['id' => $datauser->accountManagerId ]) }}"><i class="fa fa-edit"></i></a>
