...
<head>
    <meta charset="utf-8" />
    <title>Register your Account | AboveMarts Admin </title>
...
<body class='pace-top'>
    ...
    <div id="app" class="app">
            ...
            <div class="login-container">
                ...
                <div class="login-header">
                    <div class="brand">
                        ...
                        <small>Get Started As Admin To AboveMarts Platform</small>
                    </div>
                    <div class="icon">
                ...
                <div class="login-content">
                    <form action="{{ route('adminregister') }}" method="POST">
                        ...
                        <div class="form-floating mb-20px">
                            <input type="text" class="form-control fs-13px h-45px border-0" placeholder="User Name"
                                name="username" required />
                            <label for="username" class="d-flex align-items-center text-gray-600 fs-13px">Full
                                Name</label>
                        </div>
                        <div class="form-floating mb-20px">
                            <input type="text" class="form-control fs-13px h-45px border-0"
                                placeholder="Email Address" name="email" required />
                            <label for="email" class="d-flex align-items-center text-gray-600 fs-13px">Email</label>
                        </div>
                        <div class="form-floating mb-20px">
                            <select name="role" id="" class="form-control border-0">
                            ...
                            <label for="role" class="d-flex align-items-center text-gray-600 fs-13px">Role</label>
                        </div>
                        <div class="form-floating mb-20px">
                        ...
                        <div class="form-floating mb-20px">
                            ...
                            <label for="password" class="d-flex align-items-center text-gray-600 fs-13px">Confirm
                                Password</label>
                        </div>
                        ...
                        <div class="text-gray-500">
                            Already an admin? Click <a href="{{ route('adminlogin') }}" class="text-white">here</a> to
                            login.
                        </div>
                    </form>
                </div>
        ...
        <script src="cdn-cgi/scripts/7d0fa10a/cloudflare-static/rocket-loader.min.js"
            data-cf-settings="a7059b533cf10b1ac9aabf4f-|49" defer=""></script>
        <script defer src="https://static.cloudflareinsights.com/beacon.min.js/v652eace1692a40cfa3763df669d7439c1639079717194"
            integrity="sha512-Gi7xpJR8tSkrpF7aordPZQlW2DLtzUlZcumS8dMQjwDHEnw9I7ZLyiOj/6tZStRBGtGgN6ceN6cMH8z7etPGlw=="
            data-cf-beacon='{"rayId":"71e2e3faad9541bc","version":"2022.6.0","r":1,"token":"4db8c6ef997743fda032d4f73cfeff63","si":100}'
