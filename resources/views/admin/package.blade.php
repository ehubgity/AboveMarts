            ...
            <div class="col-md-12">
                <div class="left-content">
                    ...
                    <div class="d-flex">
                        ...
                        <p class="text-muted mb-0 hover-cursor">&nbsp;/&nbsp;Package History&nbsp;</p>
                        <form action="{{route('adminpackage')}}" method="GET">
            ...
            <div class="col-md-12 mt-4">
                <div class="row ">
                    ...
                    <div class="col-md-6">
                        <div class="row">
                            <div class="col-md-6">
                                <form action="{{ route('exportpackage') }}" method="GET">
                                            ...
                                            <tr class="border-bottom">
                                                ...
                                                <td>
                                                    <div class="btn-group">
                                                        ...
                                                        <button class="btn btn-danger" data-toggle="modal" title="Delete Package" data-target='#myModalDELETED{{ $datadeposit->transactionId }}'><i class="fa fa-trash"></i></button>
                                                        {{-- <button class="btn btn-danger" data-toggle="modal" title="Delete Package" data-target='#myModalDELETE{{ $datauser->userID }}'><i class="fa fa-trash"></i></button> --}}
                                                    </div>
                                                </td>
                                                @endif
                                            </tr>
                                                    ...
                                                    <div class="modal-dialog">
                                                        ...
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-footer">
                                                                <a type="submit" class="btn btn-danger" href="{{Route('adminpackage', ['unconfirmid' => $datadeposit->transactionId])}} ">Pending Transaction</a>
                                                ...
                                                <div id="myModalDELETED{{$datadeposit->transactionId}}" class="modal fade" role="dialog">
                                                    <div class="modal-dialog">
                                                        ...
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-footer">
                                                                <a type="button" class="btn btn-danger" href="{{ Route('adminpackage', ['deleteid' => $datadeposit->transactionId]) }}">Delete Transaction</a>
                                                                <button type="button" class="btn btn-default"  data-dismiss="modal">Close</button>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div id="myModalUNLOCK{{ $datadeposit->transactionId }}" class="modal fade" role="dialog">
                                                    <div class="modal-dialog">
                                                        ...
                                                        <div class="modal-footer">
                                                            <a type="button" class="btn btn-danger" href="{{ Route('adminpackage', ['confirmid' =>  $datadeposit->transactionId]) }}">Confirm Transaction</a>
                                                            <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
                                                        </div>
                                                    </div>
