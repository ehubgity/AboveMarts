        ...
        <div class="breadcrumb-header justify-content-between">
            <div class="left-content">
                <div class="d-flex">
                    ...
                    <p class="text-muted mb-0 hover-cursor">&nbsp;/&nbsp;Create Bonus&nbsp;</p>
                    ...
                    <div class="row">
                        <div class="col-md-12 col-lg-12 col-xl-12 mx-auto d-block">
                            <div class="card card-body pd-10 pd-md-20 border shadow-none">
                                <h5 class="card-title mg-b-20">Create Bonus</h5>
                                <form action="{{ route('addbonus') }}" method="post">
                                    @csrf
                                    <div class="form-group">
                                        <label class="main-content-label tx-11 tx-medium tx-gray-600">Sponsor To Credit
                                        </label> <input required class="form-control"name="sponsor" type="text"
                                            id="id" value="">
                                    </div>
                                    <div class="form-group">
                                        <label class="main-content-label tx-11 tx-medium tx-gray-600">Sponsor
                                            Who is Crediting</label> <input required
                                            class="form-control"name="sponsorId" type="text" id="id"
                                            value="">
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input required class="form-control"name="amount" type="text" id="id"
                                            value="">
                                    </div>

                                    <div class="form-group">
                                        <label class="main-content-label tx-11 tx-medium tx-gray-600">Bonus Name</label>
                                        <input required class="form-control"name="package" type="text" id="id"
                                            value="">
                                    </div>

                                    <button class="btn btn-main-primary btn-block" name="sub" type="submit">Create
                                        Bonus</button>
                                </form>
                            </div>
                        </div>
