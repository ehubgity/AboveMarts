                                ...
                                <table class="table table-bordered table-hover table-striped text-nowrap mb-0 tx-13" >
                                    ...
                                    <tbody>
                                        <tr class="border-bottom">
                                                                                        <td>{{ $datamsg->created_at }}</td>

                                            <td>{{ $datamsg->Message }}</td>
                                            <td class=""><span class="shadow-none badge outline-badge-primary"></span>{{ $datamsg->status }}</td>
                                            <td>{{ $datamsg->signalID}}</td>
