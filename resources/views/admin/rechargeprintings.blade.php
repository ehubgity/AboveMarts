    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="left-content">
            ...
            <div class="d-flex">
                ...
                <p class="text-muted mb-0 hover-cursor">&nbsp;/&nbsp;RC Printing Transactions&nbsp;</p>
                <form action="{{route('adminRP')}}" method="GET">
                                            ...
                                            <tr class="border-bottom">
                                                    ...
                                                    <div class="modal-dialog">
                                                        ...
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-footer">
                                                                <a type="submit" class="btn btn-danger" href="{{Route('adminRP', ['unconfirmid' => $data->transactionId])}} ">Pending Transaction</a>
                                                ...
                                                <div id="myModalDELETED{{$data->transactionId}}" class="modal fade" role="dialog">
                                                    <div class="modal-dialog">
                                                        ...
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-footer">
                                                                <a type="button" class="btn btn-danger" href="{{ Route('adminRP', ['deleteid' => $data->transactionId]) }}">Delete Transaction</a>
                                                                <button type="button" class="btn btn-default"  data-dismiss="modal">Close</button>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div id="myModalUNLOCK{{ $data->transactionId }}" class="modal fade" role="dialog">
                                                    <div class="modal-dialog">
                                                        ...
                                                        <div class="modal-footer">
                                                            <a type="button" class="btn btn-danger" href="{{ Route('adminRP', ['confirmid' =>  $data->transactionId]) }}">Confirm Transaction</a>
                                                            <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
                                                        </div>
                                                    </div>
                                ...
                                <table class="table table-bordered table-hover table-striped text-nowrap mb-0 tx-13" >
                                    ...
                                    <tbody>
                                        <tr class="border-bottom">
                                            ...
                                            <td>{{ $datadeposit->cost }}</td>
                                            <td>{{ $datadeposit->network }}</td>
                                            <td>{{ $datadeposit->quantity }}</td>
                                            ...
                                            <td>
                                                <div class="btn-group">
                                                    ...
                                                    @endif
                                                    {{-- <a class="btn btn-info" data-toggle="" title="Add Interest" href="{{ Route('addinterest', ['id' => $datadeposit->transactionId]) }}"><i class="fa fa-edit"></i></a>  --}}
                                            ...
                                            <div id="myModalLOCK{{$datadeposit->transactionId }}" class="modal fade" role="dialog">
                                                <div class="modal-dialog">
                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-footer">
                                                            <a type="submit" class="btn btn-danger" href="{{Route('adminRP', ['unconfirmid' => $datadeposit->transactionId])}} ">Pending Transaction</a>
                                                            <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
                                                        </div>
                                                    </div>
                                            ...
                                            <div id="myModalDELETED{{$datadeposit->transactionId}}" class="modal fade" role="dialog">
                                                <div class="modal-dialog">
                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-footer">
                                                            <a type="button" class="btn btn-danger" href="{{ Route('adminRP', ['deleteid' => $datadeposit->transactionId]) }}">Delete Transaction</a>
                                                            <button type="button" class="btn btn-default"  data-dismiss="modal">Close</button>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div id="myModalUNLOCK{{ $datadeposit->transactionId }}" class="modal fade" role="dialog">
                                                <div class="modal-dialog">
                                                    ...
                                                    <div class="modal-footer">
                                                        <a type="button" class="btn btn-danger" href="{{ Route('adminRP', ['confirmid' =>  $datadeposit->transactionId]) }}">Confirm Transaction</a>
                                                        <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
                                                    </div>
                                                </div>
