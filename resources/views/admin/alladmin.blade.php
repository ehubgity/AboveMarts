                                ...
                                <table class="table table-bordered table-hover table-striped text-nowrap mb-0 tx-13" >
                                    ...
                                    <tbody>
                                        <tr class="border-bottom">
                                            ...
                                            <td>{{ $datauser->role }}</td>
                                            <td>{{ $datauser->loginTime }}</td>
                                            <td>{{ $datauser->logoutTime }}</td>
                                            ...
                                            <td>
                                                <div class="btn-group">
                                                    @if($datauser->status =='Active')
                                                           <button class='btn btn-success' data-toggle='modal' title='Lock User' data-target='#myModalLOCK{{$datauser->admin_id}}'><i class='fa fa-unlock'></i></button>
                                                    @else
                                                        <button class='btn btn-danger' data-toggle='modal' title='Unlock User' data-target='#myModalUNLOCK{{ $datauser->admin_id }}'><i class='fa fa-lock'></i></button>
                                                    @endif
                                                    {{-- <a class="btn btn-info" data-toggle="" title="Edit Admin" href="{{ route("edituser", ['id' => $datauser->admin_id ]) }}"><i class="fa fa-edit"></i></a>  --}}
                                                    <button class="btn btn-danger" data-toggle="modal" title="Delete User" data-target='#myModalDELETED{{ $datauser->admin_id }}'><i class="fa fa-trash"></i></button>
                                                    {{-- <button class="btn btn-danger" data-toggle="modal" title="Delete User" data-target='#myModalDELETE{{ $datauser->admin_id }}'><i class="fa fa-trash"></i></button> --}}
                                                </div>
                                            </td>
                                        </tr>

                                            <div id="myModalLOCK{{$datauser->admin_id}}" class="modal fade" role="dialog">
                                                <div class="modal-dialog">
                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-footer">
                                                            <a type="submit" class="btn btn-danger" href="{{Route('alladmin', ['lockid' => $datauser->admin_id])}} ">Lock User</a>
                                            ...
                                            <div id="myModalDELETED{{$datauser->admin_id}}" class="modal fade" role="dialog">
                                                <div class="modal-dialog">
                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-footer">
                                                            <a type="button" class="btn btn-danger" href="{{ Route('alladmin', ['deleteid' => $datauser->admin_id]) }}">Delete User</a>
                                                            <button type="button" class="btn btn-default"  data-dismiss="modal">Close</button>
                                                        </div>
                                                    </div>
                                                </div>
                                                        ...
                                                        <!-- Modal -->
                                            <div id="myModalUNLOCK{{ $datauser->admin_id }}" class="modal fade" role="dialog">
                                                <div class="modal-dialog">
                                                    ...
                                                    <div class="modal-footer">
                                                        <a type="button" class="btn btn-danger" href="{{ Route('alladmin', ['unlockid' =>  $datauser->admin_id]) }}">Unlock User</a>
                                                        <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
                                                    </div>
                                                </div>
                                            ...
                                            <div id="myModalDELETE{{ $datauser->admin_id }}" class="modal fade" role="dialog">
                                                <div class="modal-dialog">
