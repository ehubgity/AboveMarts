    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="left-content">
            <div class="d-flex">
                ...
                <p class="text-muted mb-0 hover-cursor">&nbsp;/&nbsp;Add Admin&nbsp;</p>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 col-lg-12 col-xl-12 mx-auto d-block">
                                            <div class="card card-body pd-10 pd-md-20 border shadow-none">
                                                <h5 class="card-title mg-b-20">New Admin</h5>
                                                ...
                                                <div class="form-group">
                                                 ...
                                                 <div class="form-group">
                                                    <label class="main-content-label tx-11 tx-medium tx-gray-600">ROLE</label> <input class="form-control" name="role" type="text" id="role">
                                                </div>
                                                 <div class="form-group">
                                                ...
                                                <button class="btn btn-main-primary btn-block" name="sub" type="submit">Add Admin</button>
                                                </form>
                                            </div>
                                        </div>
                                    </div>
