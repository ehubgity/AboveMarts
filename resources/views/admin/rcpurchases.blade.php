    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="left-content">
            ...
            <div class="d-flex">
                ...
                <p class="text-muted mb-0 hover-cursor">&nbsp;/&nbsp;Recharge Card Transactions&nbsp;</p>
                <form action="{{route('adminRC')}}" method="GET">
                                            ...
                                            <tr class="border-bottom">
                                                    ...
                                                    <div class="modal-dialog">
                                                        ...
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-footer">
                                                                <a type="submit" class="btn btn-danger" href="{{Route('adminRC', ['unconfirmid' => $data->transactionId])}} ">Pending Transaction</a>
                                                ...
                                                <div id="myModalDELETED{{$data->transactionId}}" class="modal fade" role="dialog">
                                                    <div class="modal-dialog">
                                                        ...
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-footer">
                                                                <a type="button" class="btn btn-danger" href="{{ Route('adminRC', ['deleteid' => $data->transactionId]) }}">Delete Transaction</a>
                                                                <button type="button" class="btn btn-default"  data-dismiss="modal">Close</button>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div id="myModalUNLOCK{{ $data->transactionId }}" class="modal fade" role="dialog">
                                                    <div class="modal-dialog">
                                                        ...
                                                        <div class="modal-footer">
                                                            <a type="button" class="btn btn-danger" href="{{ Route('adminRC', ['confirmid' =>  $data->transactionId]) }}">Confirm Transaction</a>
                                                            <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
                                                        </div>
                                                    </div>
                                        ...
                                        <tr class="border-bottom">
                                            ...
                                            <div id="myModalLOCK{{$datadeposit->transactionId }}" class="modal fade" role="dialog">
                                                <div class="modal-dialog">
                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-footer">
                                                            <a type="submit" class="btn btn-danger" href="{{Route('adminRC', ['unconfirmid' => $datadeposit->transactionId])}} ">Pending Transaction</a>
                                                            <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
                                                        </div>
                                                    </div>
                                            ...
                                            <div id="myModalDELETED{{$datadeposit->transactionId}}" class="modal fade" role="dialog">
                                                <div class="modal-dialog">
                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-footer">
                                                            <a type="button" class="btn btn-danger" href="{{ Route('adminRC', ['deleteid' => $datadeposit->transactionId]) }}">Delete Transaction</a>
                                                            <button type="button" class="btn btn-default"  data-dismiss="modal">Close</button>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div id="myModalUNLOCK{{ $datadeposit->transactionId }}" class="modal fade" role="dialog">
                                                <div class="modal-dialog">
                                                    ...
                                                    <div class="modal-footer">
                                                        <a type="button" class="btn btn-danger" href="{{ Route('adminRC', ['confirmid' =>  $datadeposit->transactionId]) }}">Confirm Transaction</a>
                                                        <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
                                                    </div>
                                                </div>
