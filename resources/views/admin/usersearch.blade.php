                                    ...
                                    <tbody>
                                        <tr class="border-bottom">
                                          ...
                                          <td>{{ $datauser->accountNumber }}</td>
                                            ...
                                            <td>{{ $datauser->sponsor }}</td>                                                  <td>{{ $datauser->created_at }}</td>
             <td class=""><span class="shadow-none badge outline-badge-primary"></span>{{ $datauser->status }}</td>
                                                ...
                                                <div class="modal-dialog">
                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-footer">
                                                            <a type="submit" class="btn btn-danger" href="{{Route('adminusers', ['lockid' => $datauser->userId])}} ">Lock User</a>
                                            ...
                                            <div id="myModalDELETED{{$datauser->userId}}" class="modal fade" role="dialog">
                                                <div class="modal-dialog">
                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-footer">
                                                            <a type="button" class="btn btn-danger" href="{{ Route('adminusers', ['deleteid' => $datauser->userId]) }}">Delete User</a>
                                                            <button type="button" class="btn btn-default"  data-dismiss="modal">Close</button>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div id="myModalUNLOCK{{ $datauser->userId }}" class="modal fade" role="dialog">
                                                <div class="modal-dialog">
                                                    ...
                                                    <div class="modal-footer">
                                                        <a type="button" class="btn btn-danger" href="{{ Route('adminusers', ['unlockid' =>  $datauser->userId]) }}">Unlock User</a>
                                                        <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
                                                    </div>
                                                </div>
