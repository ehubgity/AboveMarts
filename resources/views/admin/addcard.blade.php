    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="left-content">
            <div class="d-flex">
                ...
                <p class="text-muted mb-0 hover-cursor">&nbsp;/&nbsp;Add Card&nbsp;</p>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 col-lg-12 col-xl-12 mx-auto d-block">
                                            <div class="card card-body pd-10 pd-md-20 border shadow-none">
                                                <h5 class="card-title mg-b-20">Add Card</h5>
                                                <form action="{{ route('addcard') }}" method="post" enctype="multipart/form-data">
                                                @csrf
                                                ...
                                                <div class="form-group">
                                                    <label class="main-content-label tx-11 tx-medium tx-gray-600">User ID</label> <input class="form-control"name="userId" type="text" id="id" value="0" >
                                                </div>
                                                <div class="form-group">
                                                    <label class="main-content-label tx-11 tx-medium tx-gray-600">Card ID</label> <input class="form-control"name="cardId" type="text" id="id" value="0" >
                                                </div>
                                                                                               
                                                <div class="form-group">
                                                    <label class="main-content-label tx-11 tx-medium tx-gray-600">Upload File</label> <input type="file" name="file">
                                                </div>
                                                <div class="form-group">
                                                    <button class="btn btn-main-primary btn-block" name="sub" type="submit">Submit</button>
                                                </form>
                                                </div>
                                            </div>
                                        </div>
