        ...
        <div class="breadcrumb-header justify-content-between">
            <div class="left-content">
                ...
                <div class="d-flex">
                    ...
                    <form action="{{ route('usersearchpoint') }}" method="GET">
                                ...
                                <table class="table table-bordered table-hover table-striped text-nowrap mb-0 tx-13">
                                    @foreach ($datas as $datauser)
                                        ...
                                        <tbody>
                                                    ...
                                                    <td>
                                                        <div class="btn-group">
                                                            ...
                                                            <button class='btn btn-success' data-toggle='modal'
                                                                title='Lock User'
                                                                data-target='#myModalLOCK{{ $datauser->userId }}'><i
                                                                    class='fa fa-unlock'></i></button>
                                                        @else
                                                            <button class='btn btn-danger' data-toggle='modal'
                                                                title='Unlock User'
                                                                data-target='#myModalUNLOCK{{ $datauser->userId }}'><i
                                                                    class='fa fa-lock'></i></button>
                                                        @endif --}}
                                                            <a class="btn btn-info" data-toggle=""
                                                                title="Edit User Point"
                                                                href="{{ route('edituserpoint', ['id' => $datauser->userId]) }}"><i
                                                                    class="fa fa-edit"></i></a>
                                                            {{-- <button class="btn btn-danger" data-toggle="modal"
                                                            title="Delete User"
                                                            data-target='#myModalDELETED{{ $datauser->userId }}'><i
                                            ...
                                            <div id="myModalLOCK{{ $datauser->userId }}" class="modal fade"
                                                role="dialog">
                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-footer">
                                                            <a type="submit" class="btn btn-danger"
                                                                href="{{ Route('adminuserspoint', ['lockid' => $datauser->userId]) }} ">Lock
                                                                User</a>
                                            ...
                                            <div id="myModalDELETED{{ $datauser->userId }}" class="modal fade"
                                                role="dialog">
                                                <div class="modal-dialog">
                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-footer">
                                                            <a type="button" class="btn btn-danger"
                                                                href="{{ Route('adminuserspoint', ['deleteid' => $datauser->userId]) }}">Delete
                                                                User</a>
                                                            <button type="button" class="btn btn-default"
                                                                data-dismiss="modal">Close</button>
                                                        </div>
                                            ...
                                            <!-- Modal -->
                                            <div id="myModalUNLOCK{{ $datauser->userId }}" class="modal fade"
                                                role="dialog">
                                                <div class="modal-dialog">
                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-footer">
                                                            <a type="button" class="btn btn-danger"
                                                                href="{{ Route('adminuserspoint', ['unlockid' => $datauser->userId]) }}">Unlock
                                                                User</a>
                                                            <button type="button" class="btn btn-default"
                                                                data-dismiss="modal">Close</button>
                                                        </div>
                                                ...
                                                <div id="myModalDELETE{{ $datauser->userId }}" class="modal fade"
                                                    role="dialog">
                                                    <div class="modal-dialog">
                                                            ...
                                                            @else
                                                                <button class='btn btn-danger' data-toggle='modal'
                                                                    ...
                                                                    data-target='#myModalUNLOCK{{ $datauser->userId }}'><i
                                                                        class='fa fa-lock'></i></button>
                                                            @endif
                                                            <a class="btn btn-info" data-toggle="" title="Edit User"
                                                                href="{{ route('edituser', ['id' => $datauser->userId]) }}"><i
                                                                    class="fa fa-edit"></i></a>
                                                            <button class="btn btn-danger" data-toggle="modal"
                                                                title="Delete User"
                                                                data-target='#myModalDELETED{{ $datauser->userId }}'><i
                                            ...
                                            <div id="myModalLOCK{{ $datauser->userId }}" class="modal fade"
                                                ...
                                                <div class="modal-dialog">
                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-footer">
                                                            <a type="submit" class="btn btn-danger"
                                                                href="{{ Route('adminusers', ['lockid' => $datauser->userId]) }} ">Lock
                                                                User</a>
                                                            <button type="button" class="btn btn-default"
                                                                data-dismiss="modal">Close</button>
                                                        </div>
                                            ...
                                            <div id="myModalDELETED{{ $datauser->userId }}" class="modal fade"
                                                ...
                                                <div class="modal-dialog">
                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-footer">
                                                            <a type="button" class="btn btn-danger"
                                                                href="{{ Route('adminusers', ['deleteid' => $datauser->userId]) }}">Delete
                                                                User</a>
                                                            <button type="button" class="btn btn-default"
                                                                data-dismiss="modal">Close</button>
                                                        </div>
                                            ...
                                            <div id="myModalUNLOCK{{ $datauser->userId }}" class="modal fade"
                                                ...
                                                <div class="modal-dialog">
                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-footer">
                                                            <a type="button" class="btn btn-danger"
                                                                href="{{ Route('adminusers', ['unlockid' => $datauser->userId]) }}">Unlock
                                                                User</a>
                                                            <button type="button" class="btn btn-default"
                                                                data-dismiss="modal">Close</button>
                                                        </div>
