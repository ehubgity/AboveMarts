                ...
                <div class="col-md-12 mt-4">
                    <div class="left-content">
                        ...
                        <div class="d-flex">
                            ...
                            <p class="text-muted mb-0 hover-cursor">&nbsp;/&nbsp;Point History&nbsp;</p>
                            <form action="{{ route('adminpointhistory') }}" method="GET">
                    ...
                    <div class="row ">
                        ...
                        {{-- @if (Auth::guard('admin')->user()->role == 'Superadmin')
                            <div class="col-md-6">
                                <div class="row">
                                    <div class="col-md-6">
                                        <form action="{{ route('exportbonuspoint') }}" method="GET">
                                    ...
                                    @foreach ($datas as $datadeposit)
                                        ...
                                        <tbody>
                                            <tr class="border-bottom">
                                                ...
                                                <td>{{ $datadeposit->point }}</td>
                                                <td>{{ $datadeposit->package }}</td>
                                                <td>{{ $datadeposit->sponsor }}</td>

                                                <td class=""><span
                                                        class="shadow-none badge outline-badge-primary"></span>{{ $datadeposit->status }}
                                                </td>
                                                    ...
                                                    <td>
                                                        <div class="btn-group">
                                                            ...
                                                            <button class="btn btn-danger" data-toggle="modal"
                                                                title="Delete Point"
                                                                data-target='#myModalDELETED{{ $datadeposit->transactionId }}'><i
                                            ...
                                            <div id="myModalLOCK{{ $datadeposit->transactionId }}" class="modal fade"
                                                role="dialog">
                                                <div class="modal-dialog">
                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            <p>Are you sure you want to make this transaction pending?
                                                            </p>
                                                        </div>
                                                        <div class="modal-footer">
                                                            <a type="submit" class="btn btn-danger"
                                                                href="{{ Route('adminpointhistory', ['unconfirmid' => $datadeposit->transactionId]) }} ">Pending
                                                                Transaction</a>
                                            ...
                                            <div id="myModalDELETED{{ $datadeposit->transactionId }}"
                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-footer">
                                                            <a type="button" class="btn btn-danger"
                                                                href="{{ Route('adminpointhistory', ['deleteid' => $datadeposit->transactionId]) }}">Delete
                                                                Transaction</a>
                                                            <button type="button" class="btn btn-default"
                                                                data-dismiss="modal">Close</button>
                                                        </div>
                                            ...
                                            <!-- Modal -->
                                            <div id="myModalUNLOCK{{ $datadeposit->transactionId }}"
                                                class="modal fade" role="dialog">
                                                <div class="modal-dialog">
                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-footer">
                                                            <a type="button" class="btn btn-danger"
                                                                href="{{ Route('adminpointhistory', ['confirmid' => $datadeposit->transactionId]) }}">Confirm
                                                                Transaction</a>
                                                            <button type="button" class="btn btn-default"
                                                                data-dismiss="modal">Close</button>
                                                        </div>
