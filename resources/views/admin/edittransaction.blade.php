    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="left-content">
            <div class="d-flex">
                ...
                <p class="text-muted mb-0 hover-cursor">&nbsp;/&nbsp;Edot transaction&nbsp;</p>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 col-lg-12 col-xl-12 mx-auto d-block">
                                            <div class="card card-body pd-10 pd-md-20 border shadow-none">
                                                <h5 class="card-title mg-b-20">Edit Transaction</h5>
                                                <form action="{{ route('edittransaction') }}" method="post">
                                                @csrf
                                                ...
                                                <div class="form-group">
                                                    <label class="main-content-label tx-11 tx-medium tx-gray-600">Amount (#)</label> <input class="form-control"name="amount" type="text" id="amount" value="{{ $datadeposits->amount }}">
                                                </div>
