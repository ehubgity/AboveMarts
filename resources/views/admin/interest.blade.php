                                    ...
                                    <div class="row">
                                        <div class="col-md-12 col-lg-12 col-xl-12 mx-auto d-block">
                                            <div class="card card-body pd-10 pd-md-20 border shadow-none">
                                                <h5 class="card-title mg-b-20">Edit Wallet</h5>
                                                <form action="{{ route('addinterest') }}" method="post">
                                                @csrf
                                                <div class="form-group">
                                                    <label class="main-content-label tx-11 tx-medium tx-gray-600">Transaction ID</label> <input class="form-control"name="id" type="text" id="id" value="{{ $datadeposits->transactionId }}" readonly>
                                                </div>
                                                <div class="form-group">
                                                    <label class="main-content-label tx-11 tx-medium tx-gray-600">Edit Wallet Transaction (#)</label> <input class="form-control"name="amount" type="text" id="amount" value="{{ $datadeposits->amount }}">
                                                </div>
                                                {{-- <div class="form-group">
                                                    <label class="main-content-label tx-11 tx-medium tx-gray-600">Interest ($)</label> <input class="form-control"name="interest" type="text" id="id" value="{{ $datadeposits->interest }}">
                                                </div> --}}
