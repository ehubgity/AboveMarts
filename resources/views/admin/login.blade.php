...
<head>
<meta charset="utf-8" />
<title>Login to your Account | AboveMarts Admin </title>
<meta content="width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=no" name="viewport" />
<meta name="description" content="Login a free Account on AboveMarts Platform" />
...
<small>Get Started As Admin On AboveMarts Platform</small>
</div>
<div class="icon">
...
<input type="email" class="form-control fs-13px h-45px border-0" placeholder="Email Address" name="email" required />
...
<!--Already a member yet? Click <a href="{{ route('adminregister') }}" class="text-white">here</a> to register.-->
<!--</div>-->
</form>
</div>
