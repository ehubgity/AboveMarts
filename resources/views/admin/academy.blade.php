    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="left-content">
            ...
            <div class="d-flex">
                ...
                <p class="text-muted mb-0 hover-cursor">&nbsp;/&nbsp;Academy Payment&nbsp;</p>
                        ...
                        <div class="card-body">
                            ...
                            <div class="table-responsive market-values">
                                <table class="table table-bordered table-hover table-striped text-nowrap mb-0 tx-13" >
                                    @foreach ($dataacademys as  $dataacademy)
                                    <thead>
                                        <tr>
                                    ...
                                    <tbody>
                                        <tr class="border-bottom">
                                            <td>{{ $dataacademy->transactionId}}</td>
                                            <td>{{ $dataacademy->username}}</td>
                                            <td>{{ $dataacademy->email }}</td>
                                            <td>{{ $dataacademy->amount }}</td>
                                            <td>{{ $dataacademy->package }}</td>
                                            <td class=""><span class="shadow-none badge outline-badge-primary"></span>{{ $dataacademy->status }}</td>
                                            <td>{{ $dataacademy->created_at }}</td>

                                            <td>
                                                <div class="btn-group">
                                                    @if($dataacademy->status =='CONFIRM')
                                                           <button class='btn btn-success' data-toggle='modal' title='Lock User' data-target='#myModalLOCK{{$dataacademy->transactionId}}'><i class='fa fa-unlock'></i></button>
                                                    @else
                                                        <button class='btn btn-danger' data-toggle='modal' title='Unlock User' data-target='#myModalUNLOCK{{ $dataacademy->transactionId }}'><i class='fa fa-lock'></i></button>
                                                    @endif
                                                    <a class="btn btn-info" data-toggle="" title="Add Interest" href="#"><i class="fa fa-edit"></i></a> 
                                                    <button class="btn btn-danger" data-toggle="modal" title="Delete User" data-target='#myModalDELETED{{ $dataacademy->transactionId }}'><i class="fa fa-trash"></i></button>
                                            ...
                                            <div id="myModalLOCK{{$dataacademy->transactionId }}" class="modal fade" role="dialog">
                                                <div class="modal-dialog">
                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-footer">
                                                            <a type="submit" class="btn btn-danger" href="{{Route('adminacademy', ['unconfirmid' => $dataacademy->transactionId])}} ">Pending Transaction</a>
                                            ...
                                            <div id="myModalDELETED{{$dataacademy->transactionId}}" class="modal fade" role="dialog">
                                                <div class="modal-dialog">
                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-footer">
                                                            <a type="button" class="btn btn-danger" href="{{ Route('adminacademy', ['deleteid' => $dataacademy->transactionId]) }}">Delete Transaction</a>
                                                            <button type="button" class="btn btn-default"  data-dismiss="modal">Close</button>
                                                        </div>
                                                    </div>
                                                </div>
                                                        ...
                                                        <!-- Modal -->
                                            <div id="myModalUNLOCK{{ $dataacademy->transactionId }}" class="modal fade" role="dialog">
                                                <div class="modal-dialog">
                                                    ...
                                                    <div class="modal-footer">
                                                        <a type="button" class="btn btn-danger" href="{{ Route('adminacademy', ['confirmid' =>  $dataacademy->transactionId]) }}">Confirm Transaction</a>
                                                        <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
                                                    </div>
                                                </div>
