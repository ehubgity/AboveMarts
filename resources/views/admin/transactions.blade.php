            ...
            <div class="col-md-12">
                <div class="left-content">
                    ...
                    <div class="d-flex">
                        ...
                        <p class="text-muted mb-0 hover-cursor">&nbsp;/&nbsp;Transactions&nbsp;</p>
            ...
            <div class="col-md-12 mt-4">
                <div class="row ">
                    ...
                    <div class="col-md-6">
                        <div class="row">
                            <div class="col-md-6">
                                <form action="{{ route('exporttransaction') }}" method="GET">
                                    <select name="package" class="form-control" class="select-box">
                                        <option value="None">Select Transaction</option>
                                        <option value="Package Transaction">Package Transaction</option>
                                        <option value="Data Share">Data Share</option>
                                        <option value="Recharge Card">Recharge Card</option>
                                        <option value="Recharge Printing">Recharge Printing</option>
                                        <option value="Electricity">Electricity</option>
                                        <option value="Cable Purchase">Cable Purchase</option>
                                    ...
                                    <table class="table table-bordered table-hover table-striped text-nowrap mb-0 tx-13" >
                                        ...
                                        <tbody>
                                            <tr class="border-bottom">
                                                ...
                                                <td>{{ $data->transactionService }}</td>
                                                <td>{{ $data->paymentMethod }}</td>
                                                <td>{{ $data->Admin }}</td>
                                                <td class=""><span class="shadow-none badge outline-badge-primary"></span>{{ $data->status }}</td>
                                                   <td class=""><span
                                                    class="shadow-none badge outline-badge-primary"></span>{{ $data->apiStatus }}
                                            </td>
                                        ...
                                        @endif
                                                        @if (Auth::guard('admin')->user()->role == 'Superadmin')
                                                        <a class="btn btn-info" data-toggle="" title="Edit Transaction" href="{{ Route('edittransaction', ['id' => $data->transactionId]) }}"><i class="fa fa-edit"></i></a> 
                                                       ...
                                                       @endif {{-- <button class="btn btn-danger" data-toggle="modal" title="Delete User" data-target='#myModalDELETE{{ $datauser->userID }}'><i class="fa fa-trash"></i></button> --}}
                                                    </div>
                                                </td>
                                                    ...
                                                    <div class="modal-dialog">
                                                        ...
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-footer">
                                                                <a type="submit" class="btn btn-danger" href="{{Route('transactions', ['unconfirmid' => $data->transactionId])}} ">Pending Transaction</a>
                                                ...
                                                <div id="myModalDELETED{{$data->transactionId}}" class="modal fade" role="dialog">
                                                    <div class="modal-dialog">
                                                        ...
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-footer">
                                                                <a type="button" class="btn btn-danger" href="{{ Route('transactions', ['deleteid' => $data->transactionId]) }}">Delete Transaction</a>
                                                                <button type="button" class="btn btn-default"  data-dismiss="modal">Close</button>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div id="myModalUNLOCK{{ $data->transactionId }}" class="modal fade" role="dialog">
                                                    <div class="modal-dialog">
                                                        ...
                                                        <div class="modal-footer">
                                                            <a type="button" class="btn btn-danger" href="{{ Route('transactions', ['confirmid' =>  $data->transactionId]) }}">Confirm Transaction</a>
                                                            <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
                                                        </div>
                                                    </div>
                                ...
                                <table class="table table-bordered table-hover table-striped text-nowrap mb-0 tx-13" >
                                    ...
                                    <tbody>
                                        <tr class="border-bottom">
                                            ...
                                            <td>{{ $datadeposit->phoneNumber }}</td>
                                            <td>{{ $datadeposit->amount }}</td>
                                            <td>{{ $datadeposit->transactionType }}</td>
                                            <td>{{ $datadeposit->paymentMethod }}</td>
                                              <td>{{ $datadeposit->Admin }}</td>
                                            <td class=""><span class="shadow-none badge outline-badge-primary"></span>{{ $datadeposit->status }}</td>
                                            <td class=""><span
                                                        class="shadow-none badge outline-badge-primary"></span>{{ $datadeposit->apiStatus }}
                                                </td>
                                        ...
                                        @endif
                                                          @if (Auth::guard('admin')->user()->role == 'Superadmin')
                                                    <a class="btn btn-info" data-toggle="" title="Edit Transaction" href="{{ Route('edittransaction', ['id' => $datadeposit->transactionId]) }}"><i class="fa fa-edit"></i></a> 
                                            ...
                                            <div id="myModalLOCK{{$datadeposit->transactionId }}" class="modal fade" role="dialog">
                                                <div class="modal-dialog">
                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-footer">
                                                            <a type="submit" class="btn btn-danger" href="{{Route('transactions', ['unconfirmid' => $datadeposit->transactionId])}} ">Pending Transaction</a>
                                                            <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
                                                        </div>
                                                    </div>
                                            ...
                                            <div id="myModalDELETED{{$datadeposit->transactionId}}" class="modal fade" role="dialog">
                                                <div class="modal-dialog">
                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-footer">
                                                            <a type="button" class="btn btn-danger" href="{{ Route('transactions', ['deleteid' => $datadeposit->transactionId]) }}">Delete Transaction</a>
                                                            <button type="button" class="btn btn-default"  data-dismiss="modal">Close</button>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div id="myModalUNLOCK{{ $datadeposit->transactionId }}" class="modal fade" role="dialog">
                                                <div class="modal-dialog">
                                                    ...
                                                    <div class="modal-footer">
                                                        <a type="button" class="btn btn-danger" href="{{ Route('transactions', ['confirmid' =>  $datadeposit->transactionId]) }}">Confirm Transaction</a>
                                                        <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
                                                    </div>
                                                </div>
