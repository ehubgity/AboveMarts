        ...
        <div class="breadcrumb-header justify-content-between">
            <div class="left-content">
                ...
                <div class="d-flex">
                    ...
                    <p class="text-muted mb-0 hover-cursor">&nbsp;/&nbsp;Edit User Point&nbsp;</p>
                    ...
                    <div class="row">
                        <div class="col-md-12 col-lg-12 col-xl-12 mx-auto d-block">
                            <div class="card card-body pd-10 pd-md-20 border shadow-none">
                                ...
                                <form action="{{ route('edituserpoint') }}" method="post">
                                    @csrf
                                    <div class="form-group">
                                        <label class="main-content-label tx-11 tx-medium tx-gray-600">USER ID</label>
                                        <input class="form-control"name="userId" type="text" id="id"
                                            value="{{ $data->userId }}" readonly>
                                    </div>
                                    <div class="form-group">
                                        <label class="main-content-label tx-11 tx-medium tx-gray-600">Add Point</label>
                                        <input class="form-control"name="addpoint" type="text" value="0">
                                    </div>
                                    <div class="form-group">
                                        <label class="main-content-label tx-11 tx-medium tx-gray-600">Minus
                                            Point</label>
                                        <input class="form-control"name="minuspoint" type="text" value="0">
                                    </div>


                                    <button class="btn btn-main-primary btn-block" name="sub"
