    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="left-content">
            <div class="d-flex">
                ...
                <p class="text-muted mb-0 hover-cursor">&nbsp;/&nbsp;Create E-Pin &nbsp;</p>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 col-lg-12 col-xl-12 mx-auto d-block">
                                            <div class="card card-body pd-10 pd-md-20 border shadow-none">
                                                <h5 class="card-title mg-b-20">Create E-Pin</h5>
                                                <form action="{{ route('createpin') }}" method="post">
                                                @csrf
                                                <div class="form-group">
                                                    <label class="main-content-label tx-11 tx-medium tx-gray-600">Amount</label> <input class="form-control" name="amount" type="text" id="amount" required>
                                                </div>
                                                <div class="form-group">
                                                    <label class="main-content-label tx-11 tx-medium tx-gray-600">Quantity</label> <input class="form-control" name="quantity" type="number" id="quantity" required>
                                                </div>
                                                                                            
                                              
                                                <button class="btn btn-main-primary btn-block" name="sub" type="submit">Create E-Pin</button>
                                                </form>
                                            </div>
                                        </div>
                                    </div>
