...
<head>
<meta charset="utf-8" />
<title>Password Recovery | AboveMarts </title>
...
<input type="text" class="form-control fs-13px h-45px border-0" value="{{ $data }}" name="id" readonly />
</div>

<div class="form-floating mb-20px">
    <input type="password" class="form-control fs-13px h-45px border-0" placeholder="Enter New Password"name="password" required />
    <label for="username" class="d-flex align-items-center text-gray-600 fs-13px">New Password</label>
</div>
...
<div class="form-floating mb-20px">
    ...
    <label for="username" class="d-flex align-items-center text-gray-600 fs-13px">Confirm Password</label>
</div>
