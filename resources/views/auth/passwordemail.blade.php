...
<input type="text" class="form-control fs-13px h-45px border-0" placeholder="Enter your Email Address" name="email" required />
<label for="username" class="d-flex align-items-center text-gray-600 fs-13px">Email Address</label>
</div>


<div class="mb-20px">
<button type="submit" class="btn btn-success d-block w-100 h-45px btn-lg">Password Recovery</button>
</div>
