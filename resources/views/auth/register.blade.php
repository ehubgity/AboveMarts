...
<head>
<meta charset="utf-8" />
<title>Create a new Account | AboveMarts </title>
...
<div class="form-floating mb-20px">
<input type="text" class="form-control fs-13px h-45px border-0" placeholder="Sponsor Id" value="{{ $id }}" readonly name="sponsor" />
<label for="sponsor" class="d-flex align-items-center text-gray-600 fs-13px">Invited By (Optional)</label>
</div>
<div class="form-floating mb-20px">
...
<div class="col-12">
	<div class="form-check mb-20px">
		<input class="form-check-input border-0" type="checkbox" value="1" id="rememberMe" required/>
...
Already a member? Click <a href="{{ route('login') }}" class="text-white">here to login </a>.
</div>
</form>
</div>
