...
<h4> Abovemart Bulk SMS</h4>

<form method='post' class="myForm" enctype="multipart/form-data">
@csrf

<label class="form-label col-form-label col-md-2">Sender Name</label>
<div class="row mb-15px" id="amount">
    <div class="col-md-6">
        <input name='sender_name' class="form-control" id='sender_name' class="input1" type="text" maxlength="10" name="name" placeholder="Sender's Name">
    </div>
</div>

<label  class="form-label col-form-label col-md-2"><b>Choose Contact Type</b></label>
...
<div style='display:none' id='import_field' class="wrap-input1 validate-input" data-validate="Message is required">
  ...
  <div id='manual_input_field' class="row mt-20px mb-15px w-50 wrap-input1 validate-input" data-validate="Message is required">
  ...
  <div class="wrap-input1 validate-input row mt-20px mb-15px w-50" data-validate="Message is required">
  ...
  <div class="wrap-input1 validate-input row mt-20px mb-15px w-50" data-validate="Sender Name is required">
