 <!-- FOOTER
      ...
      <footer class="pt-0 bg-dark">
        <div
          class="container border-bottom border-color-light-white py-2-5 py-md-6 mb-6 mb-md-8 mb-lg-10"
        >
          <div class="row justify-content-center mt-n1-9 align-items-center">
            <div
              class="col-sm-6 col-lg-3 mt-2-2 wow fadeIn"
            ...
            >
              <div class="d-flex">
                ...
                <div
                  class="flex-grow-1 borders-start border-color-light-white ps-4 ms-3"
                >
                  <h5 class="h6 text-white">Whatsapp Number</h5>
          ...
          <div class="row mt-n2-6">
            ...
            >
              ...
              <p class="text-white mb-4 opacity9">
                The use of Smartphone and Data Productively is indeed the new Oil and Gas. We have designed an Innovative System that can pay you as much as $10 (N5,000+) to $2,000 (N1 Million+) or even more daily by simply using your Smartphone and Data Productively...
            ...
            >
              <div class="ps-sm-2-5">
                ...
                <ul class="footer-list-style">
                  ...
                  <li><a href="{{ route('contact') }}">Our Contact</a></li>
                </ul>
              </div>
            </div>
            <div
        ...
        <div class="footer-bar">
          <div class="container">
            <div class="row align-items-center">
              <div
                class="col-md-6 text-center text-md-start mt-3 mt-md-0 order-2 order-md-1"
              >
                <p
                ...
                >
                  ...
                  <a href="#!" class="text-primary white-hover"
                    > All Rights Reserved By AboveMart</a
                  >
                </p>
              </div>
