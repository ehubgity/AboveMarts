            ...
            if (
                ...
                if (
                    ...
                    DB::table('users')
                        ->where('userId', auth()->user()->userId)
                        ->update([
                            'uplineTwo' => $dataUplineTwo->mySponsorId,
                        ]);
                    ...
                    if (
                        ...
                        DB::table('users')
                            ->where('userId', auth()->user()->userId)
                            ->update([
                                'uplineThree' => $dataUplineThree->mySponsorId,
                            ]);
                        ...
                        if (
                            ...
                            DB::table('users')
                                ->where('userId', auth()->user()->userId)
                                ->update([
                                    'uplineFour' => $dataUplineFour->mySponsorId,
                                ]);
                            $dataUplineFive = DB::table('users')
                            ...
                            if (
                                ...
                                DB::table('users')
                                    ->where('userId', auth()->user()->userId)
                                    ->update([
                                        'uplineFive' => $dataUplineFive->mySponsorId,
                                    ]);
                                ...
                                if (
                                    ...
                                    DB::table('users')
                                        ->where('userId', auth()->user()->userId)
                                        ->update([
                                            'uplineSix' => $dataUplineSix->mySponsorId,
                                        ]);
                                    ...
                                    if (
                                        ...
                                        DB::table('users')
                                            ->where('userId', auth()->user()->userId)
                                            ->update([
                                                'uplineSeven' => $dataUplineSeven->mySponsorId,
                                            ]);
                            ...
                            if (
                                ...
                                if (
                                    ...
                                    DB::table('users')
                                        ->where('userId', auth()->user()->userId)
                                        ->update([
                                            'uplineSix' => $dataUplineSix->sponsor,
                                        ]);
                                    $dataUplineSeven = DB::table('users')
                                        ->where('mySponsorId', $dataUplineSix->sponsor)
                                        ->first();
                                    if (
                                        ...
                                        DB::table('users')
                                            ->where('userId', auth()->user()->userId)
                                            ->update([
                                                'uplineSeven' => $dataUplineSeven->sponsor,
                                            ]);
                                        return redirect()->route('dashboard');
                                    } else {
                                        return redirect()->route('dashboard');
